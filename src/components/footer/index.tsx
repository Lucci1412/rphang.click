  ...
  return (
    <footer className="bg-black border-t border-gray-700 py-6 mt-4">
      <div className="container mx-auto px-4 text-sm text-gray-400">
        ...
        <p>
          Trang web này không đăng tải clip sex, video sex trẻ em. Nội dung phim
          được dẫn dụng từ trước, hoàn toàn không có thật, người xem tuyệt đối
          không bắt chước hành động trong phim, tránh vi phạm pháp luật.
        </p>
      </div>
    </footer>
  );
